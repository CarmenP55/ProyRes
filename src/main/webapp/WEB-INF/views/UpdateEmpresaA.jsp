...
<div class="container"> <br>    
          ...
          <br><br><br>
          <div class="col-sm-4" style="border: 3px solid #f1f1f1; padding:30px;">
			<h4>Empresa</h4>
			<hr>
			<form:form id="regForm" modelAttribute="empresa" action="updateEmpA" method="post">                
                <form:hidden path="id" name="id" id="id"/>
                <form:label path="nombre">Nombre</form:label>
                <form:input class="form-control" required="true" path="nombre" name="nombre" id="nombre"/><br>
                ...
                <form:textarea path="giro" name="giro" class="form-control" id="giro" /><br>
