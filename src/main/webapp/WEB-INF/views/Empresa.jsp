...
<div class="container"> <br>    
		  ...
		  <hr>		  	                           
          <form:form id="regForm" modelAttribute="empresa" action="empresaProcess" method="post">
          
          <form:label path="nombre">Nombre</form:label>
          <form:input required="true" path="nombre" name="nombre" id="nombre" class="form-control"/>  
          <form:label path="descripcion">Descripción</form:label>
          <form:textarea path="descripcion" name="descripcion" id="descripcion" class="form-control"/>
          <form:label path="giro">Giro</form:label>
          <form:textarea path="giro" name="giro" id="giro" class="form-control"/><br>
