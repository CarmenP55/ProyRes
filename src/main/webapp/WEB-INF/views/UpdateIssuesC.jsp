...
<div class="container"> <br>    
          ...
          <div class="col-sm-5" style="border: 3px solid #f1f1f1; padding:30px">
			...
			<form:form id="regForm" modelAttribute="issues" action="updateIssC" method="post">
		            ...
		            <form:textarea class="form-control" required="true" path="descripcion" name="descripcion" id="descripcion" rows="5"/>
				    ...
				    <form:select required="true" class="form-control" path="estatus_cliente" name="estatus_cliente" id="estatus_cliente">
