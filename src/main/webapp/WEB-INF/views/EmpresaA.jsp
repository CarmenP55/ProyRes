...
<div class="cuadro">
	<h2>Empresa</h2>
	<form:form id="regForm" modelAttribute="empresa" action="empresaProcessA" method="post">
                <div class="container">
                            <form:label path="nombre">Nombre</form:label>
                            <form:input required="true" path="nombre" name="nombre" id="nombre" />
                            <form:label path="descripcion">Descripción</form:label>
                            <form:textarea path="descripcion" name="descripcion" id="descripcion" /><br>
                            <form:label path="giro">Giro</form:label>
                            <form:textarea path="giro" name="giro" id="giro" /><br>
