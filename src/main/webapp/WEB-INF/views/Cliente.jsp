...
<nav id="colorNav">
					<ul>
					<li><a href="Cliente.html" class="icon-home">Inicio</a></li>	
					<li>
					<a href=ProyectosLista.html?e="${pageContext.request.userPrincipal.name}" class="icon-beaker">Proyectos</a>
					</li>
					<li>
					<a class="icon-beaker">Tickets</a>
					<ul>
					...
					<li>
					<a class="icon-beaker">Guias Rapidas</a>
					<ul>
						<li><a>Sistema Lanconta</a></li>
					</ul>
					</li>
					<li>
					<a class="icon-beaker">Mi cuenta</a>
					<ul>
