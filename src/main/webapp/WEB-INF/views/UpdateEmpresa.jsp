...
<div class="container"> <br>    
          ...
          <div class="col-sm-5" style="border: 3px solid #f1f1f1; padding:30px">
			<h4>Empresa</h4>
			<hr>
				<form:form id="regForm" modelAttribute="empresa" action="updateEmp" method="post">
                    ...
                    <form:textarea class="form-control" path="descripcion" name="descripcion" id="descripcion" />
