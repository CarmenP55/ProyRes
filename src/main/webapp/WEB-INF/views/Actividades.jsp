...
<div class="container"> <br>    
		  ...
		  <h4>Actividades</h4>
		  <hr>
		  	<form:form id="regForm" modelAttribute="actividades" action="actividadesProcess" method="post" class="form-horizontal">                            
                <form:label path="nombre">Actividad</form:label>
                <form:input required="true" path="nombre" name="nombre" id="nombre" class="form-control"/>                
                
                <form:label path="descripcion">Comentarios</form:label>
                <form:textarea path="descripcion" name="descripcion" id="descripcion" rows="4" class="form-control"/>
                
                <form:label path="cliente">Cliente involucrado?</form:label>
                <div class="radio-inline"><label><form:radiobutton path="cliente" name="cliente" id="cliente" value="SI" />SI</label></div>
                <div class="radio-inline"><label><form:radiobutton required="true" path="cliente" name="cliente" id="cliente" value="NO" />NO</label></div>
