...
<div class="container"> <br>    
          ...
          <div class="col-sm-5" style="border: 3px solid #f1f1f1; padding:30px">
			...
			<form:form id="regForm" modelAttribute="pruebas" action="updatePru" method="post">
                ...
                <form:textarea required="true" path="entrada" name="entrada" id="entrada" class="form-control" rows="3" /><br>
                <form:label path="proceso">Proceso</form:label>
                <form:textarea required="true" path="proceso" name="proceso" id="proceso" class="form-control" rows="3"/>
                <form:label path="salida">Salida</form:label>
                <form:textarea required="true" path="salida" name="salida" id="salida" class="form-control" rows="4"/>
                <form:label path="observaciones">Observaciones</form:label>
                <form:textarea required="true" path="observaciones" name="observaciones" id="observaciones" class="form-control" rows="5"/>
                ...
                <br><form:label path="estatus">Estatus</form:label>
