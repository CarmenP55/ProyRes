...
<div class="container"> <br>    
          ...
          <div class="col-sm-5" style="border: 3px solid #f1f1f1; padding:30px">
			...
			<form:form id="regForm" modelAttribute="diseno" action="updateDis" method="post">
                ...
                <form:textarea required="true" class="form-control" path="codigo" name="codigo" id="codigo" rows="6"/>
                <form:label path="argumentos">Argumentos</form:label>
                <form:textarea required="true" path="argumentos" class="form-control" name="argumentos" id="argumentos" rows="3"/>
                <form:label path="codigo">Salida</form:label>
                <form:textarea required="true" path="salida" name="salida" id="salida" class="form-control" rows="3"/>
