...
<div class="container"> <br>    
          ...
          <div class="col-sm-5" style="border: 3px solid #f1f1f1; padding:30px">
			<h2>Tareas</h2>
			<form:form id="regForm" modelAttribute="tareas" action="tareasProcessC" method="post">
                	<form:label path="nombre">Tarea</form:label>
                    <form:textarea required="true" path="nombre" name="nombre" id="nombre" class="form-control" rows="2"/>
                    <form:label path="descripcion">Descripción</form:label>
					<form:textarea required="true" path="descripcion" name="descripcion" id="descripcion" class="form-control" rows="4" /><br>                                        
                    <br>
