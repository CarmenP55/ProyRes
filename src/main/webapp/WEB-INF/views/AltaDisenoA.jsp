...
<div class="cuadro">
	<h2>Desarrollo</h2>
	<form:form id="regForm" modelAttribute="diseno" action="disenoProcessA" method="post">
                <div class="container">
                    ...
                    <form:textarea required="true" path="actividad" name="actividad" id="actividad" col="30" rows="2"/>
                    ...
                    <form:textarea required="true" path="argumentos" name="argumentos" id="argumentos" col="20" rows="3"/>                     <form:label path="codigo">Salida</form:label>
