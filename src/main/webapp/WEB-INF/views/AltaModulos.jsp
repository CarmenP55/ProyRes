...
<div class="container"> <br>    
		  ...
		  <h4>Modulos</h4>
		  <hr>
		  	<form:form id="regForm" modelAttribute="modulo" action="modulosProcess" method="post" class="form-horizontal">                            
                ...
                <form:textarea required="true" path="descripcion" name="descripcion" id="descripcion" class="form-control" rows="4" />
